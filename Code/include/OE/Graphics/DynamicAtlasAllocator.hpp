#ifndef GRAPHICS_DYNAMIC_ATLAS_ALLOCATOR_HPP
#define GRAPHICS_DYNAMIC_ATLAS_ALLOCATOR_HPP
...
namespace OrbitEngine { namespace Graphics {
	...
	*/
	...
	public:
        DynamicAtlasAllocator(unsigned int initialSize = 64, unsigned int maxSize = 4096, unsigned int sidePadding = 1);
